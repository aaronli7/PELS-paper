...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 22:58:21 2020
...
for num_of_training in range(KFOLD):
    ...
    ann_test_y = label_binarize(ann_final_test, classes=[0, 1, 2, 3, 4, 5, 6, 7])
    ann_pred_y = label_binarize(ann_final_prediction, classes=[0, 1, 2, 3, 4, 5, 6, 7])
